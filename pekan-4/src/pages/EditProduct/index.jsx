  ...
  const getProduct = async () => {
    try {
      ...
      setProdutcs({
        ...
        is_diskon: result.data.data.is_diskon,
        harga_diskon: result.data.data.harga_diskon,
        kategori: result.data.data.category,
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-5">
            ...
            <div className="md:col-span-2 flex flex-col gap-1">
              ...
              >
                ...
                {products.kategori == "makanan" ? (
                  <option selected value="makanan">
                    Makanan
                  </option>
                ) : (
                  <option value="makanan">Makanan</option>
                )}
                {products.kategori == "minuman" ? (
                ...
                {products.kategori == "hiburan" ? (
                  <option selected value="hiburan">
                    Hiburan
                  </option>
                ) : (
                  <option value="hiburan">Hiburan</option>
                )}
                {products.kategori == "kendaraan" ? (
                  <option selected value="kendaraan">
                    Kendaraan
                  </option>
                ) : (
