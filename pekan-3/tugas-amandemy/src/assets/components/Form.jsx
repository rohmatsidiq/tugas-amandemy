...
export default function Form({ getProducts }) {
  ...
  return (
    <section className="w-screen max-w-[1080px] p-3 mx-auto">
      <div className=" p-6 rounded-2xl bg-white drop-shadow-md">
        <h3 className="font-bold text-2xl text-sky-500">Created Product</h3>
        ...
        <div className="flex justify-end gap-3 mt-5">
          <button
            ...
            className="border-solid border border-sky-500 text-sky-500 bg-white px-4 py-2 rounded-2xl hover:scale-105 duration-100"
          >
            Cancel
          </button>
          <button
            onClick={handleSave}
            className="bg-sky-500 text-white px-4 py-2 rounded-2xl hover:scale-105 duration-100"
          >
            Save
          </button>
        </div>
